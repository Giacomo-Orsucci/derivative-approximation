...
/**
 * Classe di calcolo della funzione logaritmica.
 * @author Giacomo Orsucci & Leonardo Giambini 4IC.
 */
public class LogaritmoModel {
    ...
    public double calcoloY(double puntoInCuiCalcolare){
        double y;
        y = puntoInCuiCalcolare*Math.log(a*puntoInCuiCalcolare);
        return y;
    }
