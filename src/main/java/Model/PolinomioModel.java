...
public class PolinomioModel {
     ...
     * @param a, coefficiente della x^2
     * @param b, coefficiente della x
     ...
     */
    public PolinomioModel(double a, double b, double c, double limFisso, double limMobile, double precisione) {
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    public double calcoloY(double puntoInCuiCalcolare){
        double y;
        y = a * Math.pow(puntoInCuiCalcolare, 2) + b * puntoInCuiCalcolare + c;
        return y;
    }
