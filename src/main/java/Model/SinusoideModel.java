...
/**
 * Classe di calcolo della funzione sinusoidale.
 * @author Giacomo Orsucci & Leonardo Giambini 4IC.
 */
public class SinusoideModel {
     ...
     * @param a, coefficiente della x della sinusoide
     * @param b, sollevamento della funzione dall'origine
     * @param limFisso, estremo più piccolo
     * @param limMobile, estremo più grande
     * @param precisione, precisione per il dimezzamento 
     */
    public SinusoideModel(double a, double b, double limFisso, double limMobile, double precisione) {
        this.a = a;
        this.b = b;
    ...
    public double calcoloY(double puntoInCuiCalcolare){
        double y;
        y = Math.sin(a*puntoInCuiCalcolare)+b;
        return y;
    }
