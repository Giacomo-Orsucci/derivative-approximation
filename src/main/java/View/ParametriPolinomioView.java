...
import Controller.ConfermaParametriPolinomio;
import java.awt.*;
import javax.swing.*;

/**
 * Classe per la view dei parametri della funzione polimomiale.
 * @author Giacomo Orsucci & Leonardo Giambini 4IC.
 */
public class ParametriPolinomioView extends JFrame{
    ...
    private JLabel cLabel = new JLabel("Inserisci il valore di c");
     ...
     */
    public ParametriPolinomioView(){
        super("Inserimento parametri della funzione polinomiale");
        ...
        //settiamo il bottone
        confermaButton.addActionListener(new ConfermaParametriPolinomio(this));
    ...
    public JTextField getcTF() {
        return cTF;
    }

    public void setcTF(JTextField cTF) {
        this.cTF = cTF;
    }
