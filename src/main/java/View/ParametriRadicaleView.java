...
import Controller.ConfermaParametriRadicale;
import java.awt.*;
import javax.swing.*;

/**
 * Classe per la view dei parametri della funzione radicale.
 * @author Giacomo Orsucci & Leonardo Giambini 4IC.
 */
public class ParametriRadicaleView extends JFrame{
     ...
     */
    public ParametriRadicaleView(){
        super("Inserimento parametri della funzione radicale");
        ...
        //settiamo il bottone
        confermaButton.addActionListener(new ConfermaParametriRadicale(this));
